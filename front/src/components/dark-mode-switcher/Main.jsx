...
function Main(props) {
  ...
  return (
    <>
      ...
      <div
        className="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 left-0 box border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-14 "
        onClick={switchMode}
      >
